...
<div id="content" class="container col-md-12">
	...
	?>
	<h1>Recipes Not Available
		<a href="add-menu.php">
			<button class="btn btn-danger">Add New Recipe</button>
		</a>
	</h1>
	<hr />
	<?php 
					...
					<?php 
						while ($stmt_paging->fetch()){ ?>
							<tr>
								...
								<td width="20%"><img src="upload/thumbs/<?php echo $data['news_image']; ?>" width="80" height="80"/></td>
								<td width="20%"><?php echo $data['news_date'];?></td>
	...
	<?php 
		...
		$function->doPages($offset, 'recipes.php', '', $total_records, $keyword);?>
	</h4>
	</div>
