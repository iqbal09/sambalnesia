...
<div id="content" class="container col-md-12">
	...
	?>
	<div class="col-md-12">
	<h1>Add New Recipe <?php echo isset($error['add_menu']) ? $error['add_menu'] : '';?></h1>
	<hr />
	</div>
	...
	<div class="col-md-10">
		...
		<input type="text" name="news_date" value="<?php if(isset($_GET['nid'])){echo $news_date['news_date'];}?>" class="form-control">
		<br/>
